...
using real = double; // float        // float or double.
...
using Matrix13r = Eigen::Matrix<real, 13, 13>;
...
using Matrix5Xr = Eigen::Matrix<real, 5, Eigen::Dynamic>;
using MatrixX5r = Eigen::Matrix<real, Eigen::Dynamic, 5>;
